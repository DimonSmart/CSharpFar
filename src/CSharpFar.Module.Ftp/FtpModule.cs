...
public sealed class FtpModule
{
    ...
    private ModuleActionResult OpenConnectionManager(PanelSide side)
    {
        ...
        while (true)
        {
            ...
            var result = new FtpConnectionManagerDialog(StartupInfo.Ui.Dialogs).Show(connections);
            if (result is null)
        ...
        bool allowTemporaryConnection)
    {
        ...
        return new FtpConnectionDialog(StartupInfo.Ui.Dialogs, StartupInfo.Ui.Fields).Show(
