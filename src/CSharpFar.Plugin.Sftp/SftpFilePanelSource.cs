...
public sealed class SftpFilePanelSource : IPluginPanel
{
    ...
    public PanelSourceId SourceId => PanelSourceId.Plugin(SftpPluginIds.PluginId, _connection.Id);

    public string DisplayName => _connection.DisplayName;

    public PluginPanelInfo GetOpenPanelInfo() =>
        new()
        {
            Format = "SFTP",
