...
public sealed class SftpModule
{
    ...
    private ModuleActionResult OpenConnectionManager(PanelSide side)
    {
        ...
        while (true)
        {
            ...
            var result = new SftpConnectionManagerDialog(StartupInfo.Ui.Dialogs).Show(connections);
            if (result is null)
        ...
        bool allowTemporaryConnection)
    {
        ...
        return new SftpConnectionDialog(StartupInfo.Ui.Dialogs, StartupInfo.Ui.Fields).Show(
