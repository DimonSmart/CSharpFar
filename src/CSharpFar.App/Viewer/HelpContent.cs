...
public static class HelpContent
{
    ...
    [
        ...
        K("Home",            "Start of file"),
        K("End",             "Last page; local file also enables TAIL"),
        K("F1",              "Help"),
        K("F2 / Shift+F2",   "Toggle wrap / word wrap"),
        K("F3 / F10 / Esc",  "Close viewer"),
        K("F4 / H",          "Switch text / hex mode"),
        K("F",               "Local file: Off -> WATCH -> TAIL -> Off"),
        ...
        P("  WATCH refreshes a local file while preserving position."),
        P("  TAIL refreshes it and stays on the last useful page; scrolling up returns to WATCH."),
        P("  Remote and virtual viewer sources remain snapshots and do not enable live refresh."),
        E(),
        H("IN EDITOR  (F4)"),
        K("F2",              "Save file"),
        ...
        E(),
        H("CONFIGURATION"),
        K("Options → User menu...", "Configure user menu"),
