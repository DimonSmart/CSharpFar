...
public static class HelpContent
{
    ...
    [
        ...
        K("Home / End",      "Start / end of file; End enables Tail"),
        K("F",               "Live mode: Off -> Watch -> Tail -> Off"),
        K("F1",              "Help"),
        ...
        P("  Tail follows the visual EOF. Moving up or searching away from EOF switches to Watch."),
