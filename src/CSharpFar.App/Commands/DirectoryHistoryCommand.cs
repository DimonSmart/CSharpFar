...
internal sealed class DirectoryHistoryCommand : IApplicationCommand
{
    ...
    public ApplicationCommandResult Execute(ApplicationCommandContext context, object? args = null)
    {
        try
        {
            ...
            {
                new MessageDialog(context.Screen, context.Palette).Show("Directory History", $"Directory not found: {path}");
                return ApplicationCommandResult.Rendered();
            }
            ...
            {
                new MessageDialog(context.Screen, context.Palette).Show("Directory History", ex.Message);
            }
