...
internal sealed class DirectoryHistoryDialog
{
    ...
    public DirectoryHistoryDialog(ScreenRenderer screen) => _screen = screen;
        ...
        int visible, int dlgH, ConsoleSize size)
    {
        ...
        new DialogFrameRenderer().RenderFrame(_screen, bounds, "Directory History", false, Theme.DialogPopupOptions, (_, _) =>
        {
