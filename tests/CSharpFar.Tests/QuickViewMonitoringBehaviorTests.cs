...
public sealed class QuickViewMonitoringBehaviorTests : IDisposable
{
    ...
    public void RecentChangesOwnTheirHitRegionAndWheelIsConsumedAtBoundary()
    {
        ...
        ScrollableListFrame listFrame = list.CalculateFrame(new Rect(2, 6, 20, 2), new Rect(22, 6, 1, 2));
        ...
        listFrame = list.CalculateFrame(new Rect(2, 6, 20, 2), new Rect(22, 6, 1, 2));
