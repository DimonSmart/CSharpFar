...
public sealed class EditorFindDialogTests
{
    ...
    public void Show_UsesInputHistory()
    {
        ...
        var first = new EditorFindDialog(new DialogService(ModalTestHost.Create(firstDriver), new FormFieldFactory(historyRegistry))).Show(null);
        ...
        var second = new EditorFindDialog(new DialogService(ModalTestHost.Create(secondDriver), new FormFieldFactory(historyRegistry))).Show(null);
    ...
    public void Show_LongPatternAtEnd_PutsCursorInBlankCellAfterLastCharacter()
    {
        ...
        var result = new EditorFindDialog(new DialogService(ModalTestHost.Create(driver), new FormFieldFactory(CreateHistoryProvider())))
